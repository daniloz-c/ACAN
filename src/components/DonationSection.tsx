...
import AdaltoCachecol from "../img/adalto cachecol-8.png";
import AdaltoDoeLeite from "../img/adalto campanha doe leite-8.png";
                                        ...
                                        <div className="text-center">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <Button className="btn-primary mt-4">
                                                    <a
                                                        href="https://wa.me/5547991529747?text=Olá,%20gostaria%20de%20saber%20mais%20sobre%20como%20fazer%20uma%20doação"
                                                        target="_blank"
                                ...
                                <CardContent className="pt-6">
                                    <div className="text-center max-w-2xl mx-auto">
                                        ...
                                        <p className="mt-6 text-gray-600">
                                            ...
                                            doar ou para programar a entrega de
                                            doações físicas, entre em contato
                                            conosco:
                                        </p>
